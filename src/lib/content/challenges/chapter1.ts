...
export const chapter1: Challenge[] = [
  {
    ...
    questions: [
      { id: "q1", type: "multiple-choice", prompt: "What function is used to display text on the screen in Python?", prompt_th: "ฟังก์ชันใดที่ใช้แสดงข้อความบนหน้าจอใน Python?", hint: "It starts with p", hint_th: "ขึ้นต้นด้วย p", options: ["display()", "print()", "show()", "output()"], options_th: ["display()", "print()", "show()", "output()"], correctIndex: 1 },
      { id: "q2", type: "multiple-choice", prompt: "Which of the following is a valid string?", prompt_th: "ข้อใดต่อไปนี้คือสตริง (String) ที่ถูกต้อง?", hint: "Look for quotes", hint_th: "มองหาเครื่องหมายคำพูด", options: ["Hello", "\"Hello\"", "print(Hello)", "123"], options_th: ["Hello", "\"Hello\"", "print(Hello)", "123"], correctIndex: 1 },
      { id: "q3", type: "multiple-choice", prompt: "What happens if you forget quotes around text in print()?", prompt_th: "จะเกิดอะไรขึ้นถ้าคุณลืมใส่เครื่องหมายคำพูดรอบข้อความใน print()?", hint: "Python doesn't know it's text", hint_th: "Python ไม่รู้ว่ามันคือข้อความ", options: ["It prints anyway", "Python crashes/SyntaxError", "It prints a space", "Nothing happens"], options_th: ["มันพิมพ์อยู่ดี", "Python พัง/SyntaxError", "พิมพ์ช่องว่าง", "ไม่มีอะไรเกิดขึ้น"], correctIndex: 1 },
      { id: "q4", type: "multiple-choice", prompt: "Can you use single quotes (' ') for strings?", prompt_th: "คุณสามารถใช้เครื่องหมายคำพูดเดี่ยว (' ') สำหรับสตริงได้หรือไม่?", hint: "Yes, Python is flexible", hint_th: "ได้ Python มีความยืดหยุ่น", options: ["Yes", "No", "Only for numbers", "Only in Python 2"], options_th: ["ได้", "ไม่ได้", "เฉพาะตัวเลข", "เฉพาะใน Python 2"], correctIndex: 0 },
      ...
      { id: "q8", type: "typed-answer", prompt: "What punctuation surrounds the text inside a print function?", prompt_th: "เครื่องหมายวรรคตอนใดที่ล้อมรอบข้อความในฟังก์ชัน print?", hint: "They look like ()", hint_th: "หน้าตาเหมือน ()", correctAnswers: ["(", "()", "parentheses"] },
      {
        ...
        expectedOutput: "Apple\n", rules: ["Must use print()", "Must exactly match Apple"], rules_th: ["ต้องใช้ print()", "ต้องตรงกับ Apple พอดี"], 
      ...
      },
      {
        ...
        expectedOutput: "5\n", rules: ["Must use print()"], rules_th: ["ต้องใช้ print()"], 
  ...
  },
  {
    ...
    questions: [
      { id: "q1", type: "multiple-choice", prompt: "What operator is used to concatenate strings?", prompt_th: "ตัวดำเนินการใดที่ใช้ในการต่อสตริง?", hint: "Like addition", hint_th: "เหมือนการบวก", options: ["*", "-", "+", "/"], options_th: ["*", "-", "+", "/"], correctIndex: 2 },
      { id: "q2", type: "multiple-choice", prompt: "What is the result of 'A' + 'B'?", prompt_th: "ผลลัพธ์ของ 'A' + 'B' คืออะไร?", hint: "No spaces are added automatically", hint_th: "ไม่มีการเพิ่มช่องว่างอัตโนมัติ", options: ["A B", "AB", "B A", "Error"], options_th: ["A B", "AB", "B A", "ข้อผิดพลาด"], correctIndex: 1 },
      { id: "q3", type: "multiple-choice", prompt: "What happens if you try to add a string and a number? ('A' + 2)", prompt_th: "จะเกิดอะไรขึ้นถ้าคุณพยายามบวกสตริงและตัวเลข? ('A' + 2)", hint: "Python is strictly typed", hint_th: "Python เป็นภาษาที่มีชนิดข้อมูลเข้มงวด", options: ["A2", "2A", "Error", "A A"], options_th: ["A2", "2A", "ข้อผิดพลาด", "A A"], correctIndex: 2 },
      { id: "q4", type: "multiple-choice", prompt: "How do you add a space between words when concatenating?", prompt_th: "คุณจะเพิ่มช่องว่างระหว่างคำเมื่อต่อสตริงได้อย่างไร?", hint: "Add a space string", hint_th: "เพิ่มสตริงช่องว่าง", options: ["' '", "space()", "++", "&"], options_th: ["' '", "space()", "++", "&"], correctIndex: 0 },
      ...
      { id: "q8", type: "typed-answer", prompt: "What is '1' + '1'?", prompt_th: "'1' + '1' ได้ผลลัพธ์เป็นอะไร?", hint: "String addition, not math", hint_th: "การต่อสตริง ไม่ใช่คณิตศาสตร์", correctAnswers: ["11"] },
      {
        ...
        expectedOutput: "Superman\n", rules: ["Must use +"], rules_th: ["ต้องใช้ +"], 
  ...
  },
  {
    ...
    questions: [
      { id: "q1", type: "multiple-choice", prompt: "What symbol assigns a value to a variable?", prompt_th: "สัญลักษณ์ใดที่ใช้กำหนดค่าให้กับตัวแปร?", hint: "Assign, not compare", hint_th: "กำหนดค่า ไม่ใช่เปรียบเทียบ", options: ["==", ":", "=", "->"], options_th: ["==", ":", "=", "->"], correctIndex: 2 },
      { id: "q2", type: "multiple-choice", prompt: "Which is a valid variable name?", prompt_th: "ข้อใดคือชื่อตัวแปรที่ถูกต้อง?", hint: "Cannot start with a number", hint_th: "ไม่สามารถขึ้นต้นด้วยตัวเลขได้", options: ["1name", "my-name", "my_name", "my name"], options_th: ["1name", "my-name", "my_name", "my name"], correctIndex: 2 },
      { id: "q3", type: "multiple-choice", prompt: "If x = 5, what does print(x) output?", prompt_th: "ถ้า x = 5 แล้ว print(x) จะแสดงผลอะไร?", hint: "It prints the value", hint_th: "มันพิมพ์ค่าของตัวแปร", options: ["x", "5", "Error", "print(x)"], options_th: ["x", "5", "ข้อผิดพลาด", "print(x)"], correctIndex: 1 },
      { id: "q4", type: "multiple-choice", prompt: "Can a variable change its value later?", prompt_th: "ตัวแปรสามารถเปลี่ยนค่าในภายหลังได้หรือไม่?", hint: "They are variable", hint_th: "มันคือตัวที่เปลี่ยนแปลงได้", options: ["Yes", "No", "Only if it's a number", "Only if it's a string"], options_th: ["ได้", "ไม่ได้", "เฉพาะตัวเลข", "เฉพาะสตริง"], correctIndex: 0 },
      ...
      { id: "q8", type: "typed-answer", prompt: "What character is standard for spaces in variable names?", prompt_th: "อักขระใดเป็นมาตรฐานแทนช่องว่างในชื่อตัวแปร?", hint: "Bottom line", hint_th: "เส้นด้านล่าง", correctAnswers: ["_", "underscore"] },
      {
        ...
        expectedOutput: "20\n", rules: ["Must create variable age"], rules_th: ["ต้องสร้างตัวแปร age"], 
      ...
      },
      {
        ...
        expectedOutput: "2\n", rules: ["Reassign x"], rules_th: ["กำหนดค่า x ใหม่"], 
  ...
  },
  {
    ...
    questions: [
      { id: "q1", type: "multiple-choice", prompt: "What is the symbol for multiplication?", prompt_th: "สัญลักษณ์สำหรับการคูณคืออะไร?", hint: "Star", hint_th: "ดาว", options: ["x", "*", ".", "^"], options_th: ["x", "*", ".", "^"], correctIndex: 1 },
      { id: "q2", type: "multiple-choice", prompt: "What is 10 / 2?", prompt_th: "10 / 2 คืออะไร?", hint: "Division returns a float", hint_th: "การหารจะคืนค่าเป็นเลขทศนิยม (float)", options: ["5", "5.0", "Error", "10/2"], options_th: ["5", "5.0", "ข้อผิดพลาด", "10/2"], correctIndex: 1 },
      { id: "q3", type: "multiple-choice", prompt: "What does Python evaluate first: 2 + 3 * 2?", prompt_th: "Python จะประมวลผลส่วนใดก่อน: 2 + 3 * 2?", hint: "PEMDAS", hint_th: "ตามหลัก PEMDAS", options: ["10", "8", "7", "12"], options_th: ["10", "8", "7", "12"], correctIndex: 1 },
      { id: "q4", type: "multiple-choice", prompt: "What data type is a whole number?", prompt_th: "ข้อมูลประเภทใดที่เป็นจำนวนเต็ม?", hint: "Integer", hint_th: "Integer", options: ["String", "Float", "Integer", "Boolean"], options_th: ["ข้อความ", "ทศนิยม", "จำนวนเต็ม", "บูลีน"], correctIndex: 2 },
      ...
      { id: "q8", type: "typed-answer", prompt: "What is 4 * 4?", prompt_th: "4 * 4 คืออะไร?", hint: "Math", hint_th: "คณิตศาสตร์", correctAnswers: ["16"] },
      {
        ...
        expectedOutput: "5.0\n", rules: ["Must use math operators"], rules_th: ["ต้องใช้ตัวดำเนินการทางคณิตศาสตร์"], 
      ...
      },
      {
        ...
        expectedOutput: "10\n", rules: ["Order of operations"], rules_th: ["ลำดับการดำเนินการ"], 
  ...
  },
  {
    ...
    title: "input()",
    questions: [
      { id: "q1", type: "multiple-choice", prompt: "What function pauses the program to ask the user for text?", prompt_th: "ฟังก์ชันใดที่หยุดโปรแกรมชั่วคราวเพื่อขอข้อความจากผู้ใช้?", hint: "It takes input", hint_th: "มันรับข้อมูล (input)", options: ["ask()", "prompt()", "input()", "get()"], options_th: ["ask()", "prompt()", "input()", "get()"], correctIndex: 2 },
      { id: "q2", type: "multiple-choice", prompt: "What data type does input() always return?", prompt_th: "ฟังก์ชัน input() จะคืนค่าชนิดข้อมูลใดเสมอ?", hint: "Even if they type a number, it's text", hint_th: "แม้จะพิมพ์ตัวเลข มันก็เป็นข้อความ", options: ["Integer", "String", "Float", "Boolean"], options_th: ["จำนวนเต็ม", "ข้อความ", "ทศนิยม", "บูลีน"], correctIndex: 1 },
      { id: "q3", type: "multiple-choice", prompt: "Where do you put the prompt text for the user?", prompt_th: "คุณจะใส่ข้อความคำแนะนำสำหรับผู้ใช้ไว้ที่ไหน?", hint: "Inside", hint_th: "ข้างใน", options: ["Before input()", "Inside input('...')", "After input()", "You can't"], options_th: ["ก่อน input()", "ใน input('...')", "หลัง input()", "คุณทำไม่ได้"], correctIndex: 1 },
      { id: "q4", type: "multiple-choice", prompt: "How do you save the user's input?", prompt_th: "คุณจะบันทึกข้อมูลที่ผู้ใช้พิมพ์ได้อย่างไร?", hint: "Variables", hint_th: "ใช้ตัวแปร", options: ["x = input()", "input() = x", "save(input())", "store input()"], options_th: ["x = input()", "input() = x", "save(input())", "store input()"], correctIndex: 0 },
      ...
      { id: "q8", type: "typed-answer", prompt: "What character goes inside input to prompt?", prompt_th: "อักขระใดที่ต้องใส่ใน input เพื่อแสดงข้อความ?", hint: "Quotes", hint_th: "เครื่องหมายคำพูด", correctAnswers: ["quotes", "\"", "'"] },
      {
        ...
        expectedOutput: "25\n", rules: ["Use input()"], rules_th: ["ใช้ input()"], 
  ...
  },
  {
    ...
    questions: [
      { id: "q1", type: "multiple-choice", prompt: "What are the two Boolean values?", prompt_th: "ค่า Boolean สองค่าคืออะไร?", hint: "Binary", hint_th: "เลขฐานสอง (Binary)", options: ["Yes and No", "True and False", "1 and 2", "On and Off"], options_th: ["Yes และ No", "True และ False", "1 และ 2", "On และ Off"], correctIndex: 1 },
      { id: "q2", type: "multiple-choice", prompt: "Which is correct capitalization in Python?", prompt_th: "การใช้ตัวพิมพ์ใหญ่/เล็กที่ถูกต้องใน Python คือข้อใด?", hint: "Title case", hint_th: "ขึ้นต้นด้วยตัวใหญ่", options: ["true", "TRUE", "True", "tRue"], options_th: ["true", "TRUE", "True", "tRue"], correctIndex: 2 },
      { id: "q3", type: "multiple-choice", prompt: "What operator checks if two values are equal?", prompt_th: "ตัวดำเนินการใดตรวจสอบว่าสองค่าเท่ากันหรือไม่?", hint: "Double", hint_th: "แบบคู่", options: ["=", "==", "===", "=>"], options_th: ["=", "==", "===", "=>"], correctIndex: 1 },
      { id: "q4", type: "multiple-choice", prompt: "What is 5 > 3?", prompt_th: "5 > 3 คืออะไร?", hint: "Math", hint_th: "คณิตศาสตร์", options: ["True", "False", "Error", "2"], options_th: ["True", "False", "ข้อผิดพลาด", "2"], correctIndex: 0 },
  ...
  },
  {
    ...
    questions: [
      { id: "q1", type: "multiple-choice", prompt: "What keyword starts a conditional statement?", prompt_th: "คำสำคัญใดที่เริ่มต้นคำสั่งเงื่อนไข?", hint: "if this...", hint_th: "ถ้าเป็นเช่นนี้...", options: ["when", "if", "check", "do"], options_th: ["when", "if", "check", "do"], correctIndex: 1 },
      { id: "q2", type: "multiple-choice", prompt: "What punctuation MUST follow an if condition?", prompt_th: "เครื่องหมายวรรคตอนใดที่ต้องตามหลังเงื่อนไข if เสมอ?", hint: "Two dots", hint_th: "จุดสองจุด", options: [";", ",", ".", ":"], options_th: [";", ",", ".", ":"], correctIndex: 3 },
      { id: "q3", type: "multiple-choice", prompt: "How does Python know what code is inside the if block?", prompt_th: "Python จะรู้ได้อย่างไรว่าโค้ดใดอยู่ภายในบล็อก if?", hint: "Space matters", hint_th: "ช่องว่างมีผล", options: ["Brackets {}", "Indentation (spaces)", "Parentheses ()", "End keyword"], options_th: ["วงเล็บ {}", "การเว้นวรรค (spaces)", "วงเล็บ ()", "คำว่า End"], correctIndex: 1 },
      { id: "q4", type: "multiple-choice", prompt: "What keyword is used for 'otherwise'?", prompt_th: "คำสำคัญใดที่ใช้สำหรับ 'มิฉะนั้น' (otherwise)?", hint: "else", hint_th: "else", options: ["otherwise", "then", "else", "except"], options_th: ["otherwise", "then", "else", "except"], correctIndex: 2 },
      ...
      { id: "q8", type: "typed-answer", prompt: "If condition is False, does the if-block run?", prompt_th: "หากเงื่อนไขเป็นเท็จ (False) บล็อกโค้ดใต้ if จะทำงานหรือไม่?", hint: "yes or no", hint_th: "yes หรือ no", correctAnswers: ["no"] },
      {
        ...
        expectedOutput: "Yes\n", rules: ["Must use if"], rules_th: ["ต้องใช้ if"], 
      ...
      },
      {
        ...
        expectedOutput: "B\n", rules: ["Must use else"], rules_th: ["ต้องใช้ else"], 
  ...
  },
  {
    ...
    questions: [
      { id: "q1", type: "multiple-choice", prompt: "Which keyword creates a loop that runs a specific number of times?", prompt_th: "คำสำคัญใดที่สร้างลูปที่ทำงานตามจำนวนครั้งที่กำหนด?", hint: "for every item...", hint_th: "สำหรับทุกรายการ...", options: ["while", "loop", "for", "repeat"], options_th: ["while", "loop", "for", "repeat"], correctIndex: 2 },
      { id: "q2", type: "multiple-choice", prompt: "What function generates a sequence of numbers?", prompt_th: "ฟังก์ชันใดที่สร้างลำดับตัวเลข?", hint: "range", hint_th: "range", options: ["list()", "range()", "seq()", "numbers()"], options_th: ["list()", "range()", "seq()", "numbers()"], correctIndex: 1 },
      { id: "q3", type: "multiple-choice", prompt: "What does range(3) generate?", prompt_th: "range(3) จะสร้างลำดับอะไรออกมา?", hint: "Starts at 0", hint_th: "เริ่มที่ 0", options: ["1, 2, 3", "0, 1, 2", "3, 3, 3", "0, 1, 2, 3"], options_th: ["1, 2, 3", "0, 1, 2", "3, 3, 3", "0, 1, 2, 3"], correctIndex: 1 },
      { id: "q4", type: "multiple-choice", prompt: "Like if statements, for loops require...", prompt_th: "เช่นเดียวกับคำสั่ง if, ลูป for ต้องมีอะไรบ้าง?", hint: "Spacing", hint_th: "การเว้นวรรค", options: ["Indentation", "Brackets", "Semicolons", "End tags"], options_th: ["การเว้นวรรค", "วงเล็บ", "อัฒภาค (Semicolons)", "แท็กปิด"], correctIndex: 0 },
      ...
      { id: "q8", type: "typed-answer", prompt: "What is the keyword that loops while a condition is true?", prompt_th: "คำสำคัญใดที่ทำลูปขณะที่เงื่อนไขเป็นจริง?", hint: "while", hint_th: "while", correctAnswers: ["while"] },
      {
        ...
        expectedOutput: "0\n1\n2\n", rules: ["Must use for"], rules_th: ["ต้องใช้ for"], 
      ...
      },
      {
        ...
        expectedOutput: "1\n2\n", rules: ["Must use while"], rules_th: ["ต้องใช้ while"], 
  ...
  },
  {
    ...
    questions: [
      { id: "q1", type: "multiple-choice", prompt: "What brackets are used to create a list?", prompt_th: "ใช้วงเล็บแบบใดในการสร้างลิสต์ (list)?", hint: "Square", hint_th: "แบบสี่เหลี่ยม (Square)", options: ["()", "{}", "[]", "<>"], options_th: ["()", "{}", "[]", "<>"], correctIndex: 2 },
      { id: "q2", type: "multiple-choice", prompt: "How are items separated in a list?", prompt_th: "แต่ละรายการในลิสต์ถูกคั่นด้วยอะไร?", hint: "Comma", hint_th: "จุลภาค (Comma)", options: ["Spaces", "Commas", "Semicolons", "Dots"], options_th: ["ช่องว่าง", "จุลภาค", "อัฒภาค", "จุด"], correctIndex: 1 },
      { id: "q3", type: "multiple-choice", prompt: "What index is the FIRST item in a list?", prompt_th: "ดัชนี (index) ของรายการแรกในลิสต์คือหมายเลขใด?", hint: "Zero-indexed", hint_th: "ดัชนีเริ่มต้นที่ศูนย์", options: ["1", "0", "-1", "A"], options_th: ["1", "0", "-1", "A"], correctIndex: 1 },
      { id: "q4", type: "multiple-choice", prompt: "How do you add an item to the end of a list?", prompt_th: "จะเพิ่มข้อมูลใหม่ไว้ที่ท้ายสุดของลิสต์ได้อย่างไร?", hint: "append", hint_th: "append", options: [".add()", ".push()", ".insert()", ".append()"], options_th: [".add()", ".push()", ".insert()", ".append()"], correctIndex: 3 },
      ...
      { id: "q8", type: "typed-answer", prompt: "Can lists hold mixed data types (strings and numbers)?", prompt_th: "ลิสต์สามารถเก็บข้อมูลต่างชนิดรวมกัน (ข้อความและตัวเลข) ได้หรือไม่?", hint: "yes or no", hint_th: "yes หรือ no", correctAnswers: ["yes"] },
      {
        ...
        expectedOutput: "10\n", rules: ["Must use list indexing"], rules_th: ["ต้องใช้การอ้างอิงดัชนีลิสต์"], 
        tests: [{ assertStdout: "10\n" }]
      },
      {
        ...
        expectedOutput: "[1, 2]\n", rules: ["Must use append"], rules_th: ["ต้องใช้ append"], 
  ...
  },
  {
    ...
    questions: [
      { id: "q1", type: "multiple-choice", prompt: "What keyword defines a function?", prompt_th: "คำสำคัญใดที่ใช้ประกาศฟังก์ชัน?", hint: "define", hint_th: "define", options: ["function", "def", "fun", "create"], options_th: ["function", "def", "fun", "create"], correctIndex: 1 },
      { id: "q2", type: "multiple-choice", prompt: "What keyword sends a value back from a function?", prompt_th: "คำสำคัญใดที่ใช้ส่งค่ากลับจากฟังก์ชัน?", hint: "return", hint_th: "return", options: ["send", "output", "return", "give"], options_th: ["send", "output", "return", "give"], correctIndex: 2 },
      { id: "q3", type: "multiple-choice", prompt: "How do you call a function named `greet`?", prompt_th: "คุณจะเรียกใช้งานฟังก์ชันชื่อ `greet` อย่างไร?", hint: "Parentheses", hint_th: "วงเล็บ", options: ["greet", "call greet", "greet()", "run greet"], options_th: ["greet", "call greet", "greet()", "run greet"], correctIndex: 2 },
      { id: "q4", type: "multiple-choice", prompt: "Variables inside () in a function definition are called...", prompt_th: "ตัวแปรที่อยู่ภายใน () ในการประกาศฟังก์ชันเรียกว่าอะไร?", hint: "Parameters", hint_th: "พารามิเตอร์", options: ["Arguments/Parameters", "Values", "Lists", "Returns"], options_th: ["Arguments/Parameters", "Values", "Lists", "Returns"], correctIndex: 0 },
      ...
      { id: "q8", type: "typed-answer", prompt: "If `def add(a):` what is `a` called?", prompt_th: "จาก `def add(a):` ตัว `a` เรียกว่าอะไร?", hint: "parameter", hint_th: "พารามิเตอร์", correctAnswers: ["parameter", "argument"] },
      {
        ...
        expectedOutput: "Hi\n", rules: ["Must use def"], rules_th: ["ต้องใช้ def"], 
      ...
      },
      {
        ...
        expectedOutput: "5\n", rules: ["Must use return"], rules_th: ["ต้องใช้ return"], 
        tests: [{ assertStdout: "5\n" }]
      }
    ]
  }
