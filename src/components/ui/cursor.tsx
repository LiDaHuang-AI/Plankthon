...
function Cursor({ className, ...props }: CursorProps) {
  return (
    <CursorPrimitive {...props}>
      <svg
        className={cn('size-6 text-text drop-shadow-[0_0_5px_rgba(0,0,0,0.3)]', className)}
...
function CursorFollow({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'bg-text rounded-md text-bg font-bold px-2 py-1 text-sm shadow-[0_0_10px_rgba(0,0,0,0.3)]',
          className,
        )}
      >
        {children}
